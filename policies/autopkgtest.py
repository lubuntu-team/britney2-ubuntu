...
class AutopkgtestPolicy(BasePolicy):
    ...
    def __init__(self, options):
        super().__init__('autopkgtest', options, {'unstable'})
    ...
    def register_hints(self, hint_parser):
        hint_parser.register_hint_type('force-badtest', hints.split_into_one_hint_per_package)
        hint_parser.register_hint_type('force-skiptest', hints.split_into_one_hint_per_package)
